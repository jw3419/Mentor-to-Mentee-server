...
module.exports = {
  get: async (req, res) => {
    ...
    let receivedQuestion = menteeInfo[0].dataValues.mentee.dataValues.qas.map((el) => {
      return {
        id: el.dataValues.id,
        ...
        menteeMajor: menteeInfo[0].dataValues.mentee.dataValues.menteeMajor,
        menteeGraduation: menteeInfo[0].dataValues.mentee.dataValues.menteeGraduation,
        menteeGrade: menteeInfo[0].dataValues.mentee.dataValues.menteeGrade,
      }
    })
    ...
    let sentQuestion = mentorInfo[0].dataValues.mentor.dataValues.qas.map((el) => {
      return {
        id: el.dataValues.id,
        brief: el.dataValues.brief,
        question: el.dataValues.question,
